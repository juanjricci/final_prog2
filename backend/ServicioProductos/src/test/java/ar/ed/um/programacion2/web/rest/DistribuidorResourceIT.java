...
class DistribuidorResourceIT {
    ...
    public static Distribuidor createEntity(EntityManager em) {
        Distribuidor distribuidor = new Distribuidor().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION);
        return distribuidor;
    }
    ...
    public static Distribuidor createUpdatedEntity(EntityManager em) {
        Distribuidor distribuidor = new Distribuidor().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
        return distribuidor;
    }
    ...
    void createDistribuidor() throws Exception {
        ...
        restDistribuidorMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(distribuidor)))
    ...
    void putNewDistribuidor() throws Exception {
        ...
        updatedDistribuidor.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);

        restDistribuidorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDistribuidor.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedDistribuidor))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingDistribuidor() throws Exception {
        ...
        restDistribuidorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, distribuidor.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(distribuidor))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamDistribuidor() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDistribuidorMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(distribuidor)))
    ...
    void partialUpdateDistribuidorWithPatch() throws Exception {
        ...
        partialUpdatedDistribuidor.nombre(UPDATED_NOMBRE);
    ...
    void fullUpdateDistribuidorWithPatch() throws Exception {
        ...
        partialUpdatedDistribuidor.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
    ...
    void patchNonExistingDistribuidor() throws Exception {
        ...
        restDistribuidorMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, distribuidor.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(distribuidor))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamDistribuidor() throws Exception {
        ...
        restDistribuidorMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(distribuidor))
            )
            .andExpect(status().isMethodNotAllowed());
