...
class ProductoResourceIT {
    ...
    private static final Long DEFAULT_CANT_VENDIDA = 1L;
    private static final Long UPDATED_CANT_VENDIDA = 2L;
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto()
            ...
            .cantVendida(DEFAULT_CANT_VENDIDA);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto()
            ...
            .cantVendida(UPDATED_CANT_VENDIDA);
        return producto;
    }
    ...
    void createProducto() throws Exception {
        ...
        assertThat(testProducto.getCantVendida()).isEqualTo(DEFAULT_CANT_VENDIDA);
    }
    ...
    void getAllProductos() throws Exception {
        ...
        restProductoMockMvc
            ...
            .andExpect(jsonPath("$.[*].cantVendida").value(hasItem(DEFAULT_CANT_VENDIDA.intValue())));
    }
    ...
    void getProducto() throws Exception {
        ...
        restProductoMockMvc
            ...
            .andExpect(jsonPath("$.cantVendida").value(DEFAULT_CANT_VENDIDA.intValue()));
    }
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).precio(UPDATED_PRECIO).cantVendida(UPDATED_CANT_VENDIDA);
        ...
        assertThat(testProducto.getCantVendida()).isEqualTo(UPDATED_CANT_VENDIDA);
    }
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
