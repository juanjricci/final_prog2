  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productosDistribuidorApp.distribuidor.home.createOrEditLabel" data-cy="DistribuidorCreateUpdateHeading">
            <Translate contentKey="productosDistribuidorApp.distribuidor.home.createOrEditLabel">Create or edit a Distribuidor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('productosDistribuidorApp.distribuidor.nombre')}
              ...
              />
              <ValidatedField
                label={translate('productosDistribuidorApp.distribuidor.descripcion')}
