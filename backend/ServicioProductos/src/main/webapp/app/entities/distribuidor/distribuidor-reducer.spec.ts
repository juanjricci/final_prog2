...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRIBUIDOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISTRIBUIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISTRIBUIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISTRIBUIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISTRIBUIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISTRIBUIDOR actions', async () => {
      const expectedActions = [
        {
