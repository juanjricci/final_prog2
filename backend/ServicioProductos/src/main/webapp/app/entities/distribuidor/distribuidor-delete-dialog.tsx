...
export const DistribuidorDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productosDistribuidorApp.distribuidor.delete.question">
        <Translate contentKey="productosDistribuidorApp.distribuidor.delete.question" interpolate={{ id: distribuidorEntity.id }}>
