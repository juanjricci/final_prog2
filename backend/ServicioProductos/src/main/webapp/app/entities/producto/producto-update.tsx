  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productosDistribuidorApp.producto.home.createOrEditLabel" data-cy="ProductoCreateUpdateHeading">
            <Translate contentKey="productosDistribuidorApp.producto.home.createOrEditLabel">Create or edit a Producto</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('productosDistribuidorApp.producto.nombre')}
                id="producto-nombre"
                name="nombre"
                data-cy="nombre"
                type="text"
              />
              <ValidatedField
                label={translate('productosDistribuidorApp.producto.descripcion')}
              ...
              />
              <ValidatedField
                label={translate('productosDistribuidorApp.producto.precio')}
                id="producto-precio"
                name="precio"
                data-cy="precio"
                type="text"
              />
              <ValidatedField
                label={translate('productosDistribuidorApp.producto.cantVendida')}
                id="producto-cantVendida"
                name="cantVendida"
                data-cy="cantVendida"
                type="text"
              />
              <ValidatedField
                ...
                label={translate('productosDistribuidorApp.producto.distribuidor')}
                type="select"
              >
                <option value="" key="0" />
                {distribuidors
