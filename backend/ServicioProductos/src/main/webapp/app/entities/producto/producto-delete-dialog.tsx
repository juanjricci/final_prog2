...
export const ProductoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productosDistribuidorApp.producto.delete.question">
        <Translate contentKey="productosDistribuidorApp.producto.delete.question" interpolate={{ id: productoEntity.id }}>
