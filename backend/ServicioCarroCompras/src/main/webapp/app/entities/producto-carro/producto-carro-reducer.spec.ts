...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOCARRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOCARRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOCARRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOCARRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOCARRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOCARRO actions', async () => {
      const expectedActions = [
        {
