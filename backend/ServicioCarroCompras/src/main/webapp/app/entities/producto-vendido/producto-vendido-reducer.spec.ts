...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOVENDIDO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOVENDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOVENDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOVENDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOVENDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOVENDIDO actions', async () => {
      const expectedActions = [
        {
