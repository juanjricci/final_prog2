...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './usuario.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USUARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_USUARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USUARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USUARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USUARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USUARIO actions', async () => {
      const expectedActions = [
        {
