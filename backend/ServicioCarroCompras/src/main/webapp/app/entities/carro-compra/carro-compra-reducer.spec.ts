...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARROCOMPRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARROCOMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARROCOMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARROCOMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARROCOMPRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARROCOMPRA actions', async () => {
      const expectedActions = [
        {
