...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './venta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_VENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VENTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VENTA actions', async () => {
      const expectedActions = [
        {
