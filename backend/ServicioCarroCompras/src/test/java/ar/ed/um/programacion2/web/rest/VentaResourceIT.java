...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fechaVenta(DEFAULT_FECHA_VENTA).precioTotal(DEFAULT_PRECIO_TOTAL);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fechaVenta(UPDATED_FECHA_VENTA).precioTotal(UPDATED_PRECIO_TOTAL);
        return venta;
    }
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getPrecioTotal()).isEqualTo(DEFAULT_PRECIO_TOTAL);
    }
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.fechaVenta(UPDATED_FECHA_VENTA).precioTotal(UPDATED_PRECIO_TOTAL);
        ...
        assertThat(testVenta.getPrecioTotal()).isEqualTo(UPDATED_PRECIO_TOTAL);
    }
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.precioTotal(UPDATED_PRECIO_TOTAL);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fechaVenta(UPDATED_FECHA_VENTA).precioTotal(UPDATED_PRECIO_TOTAL);
