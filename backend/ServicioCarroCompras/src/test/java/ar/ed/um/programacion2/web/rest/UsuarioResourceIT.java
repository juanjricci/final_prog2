...
class UsuarioResourceIT {
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).email(UPDATED_EMAIL).clave(UPDATED_CLAVE).tipo(UPDATED_TIPO);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).tipo(UPDATED_TIPO);
